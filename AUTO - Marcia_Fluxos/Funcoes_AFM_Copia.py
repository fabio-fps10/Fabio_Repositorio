...
def Mais_Fluxo(sigla_mes,ultimo_domingo):
    ...
    for UE in lista_UE:
        fluxo = pd.read_excel(f"V:\\BI\\Scripts\\Fabio\\AUTO - Marcia_Fluxos\\Fluxos\\Mais_Fluxo\\{UE}_{sigla_mes}_{ultimo_domingo}.xls")
...
def Manipulacao_Dados(mes_atual,ultimo_domingo):
    ...
    diretorio = r'V:\BI\Scripts\Fabio\AUTO - Marcia_Fluxos\Fluxos'
...
def Edicao_Excel(mes_atual,ultimo_domingo):
    workbook = openpyxl.load_workbook(f"V:\\BI\\Scripts\\Fabio\\AUTO - Marcia_Fluxos\\Fluxos\\Fluxos até {ultimo_domingo} de {mes_atual}.xlsx")
    ...
    workbook.save(f"V:\\BI\\Scripts\\Fabio\\AUTO - Marcia_Fluxos\\Fluxos\\Fluxos até {ultimo_domingo} de {mes_atual}.xlsx")
